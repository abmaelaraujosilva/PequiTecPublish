...
namespace PequiTec.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            if (TempData["RecuperarSenha"] != null)
                ViewBag.RecuperarSenha = TempData["RecuperarSenha"];
            return View();
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToLocal("/Noticia/Index");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Alterar Senha", "Para alterar sua senha, clique <a href=\"" + callbackUrl + "\">AQUI</a>");
                TempData["RecuperarSenha"] = "2";
